!function(e, t) {
    ...
    class I {
        ...
        constructor(e, t=0, i, n) {
            ...
            0 === e)
                ...
                m("Invalid input argument for BufferView: " + e)
        }
        _swapArrayBuffer(e) {
        ...
        getInt8(e) {return this.dataView.getInt8(e)}
        getUint8(e) {return this.dataView.getUint8(e)}
        getInt16(e, t=this.le) {return this.dataView.getInt16(e, t)}
        getInt32(e, t=this.le) {return this.dataView.getInt32(e, t)}
        getUint16(e, t=this.le) {return this.dataView.getUint16(e, t)}
        getUint32(e, t=this.le) {return this.dataView.getUint32(e, t)}
        getFloat32(e, t=this.le) {return this.dataView.getFloat32(e, t)}
        getFloat64(e, t=this.le) {return this.dataView.getFloat64(e, t)}
        getFloat(e, t=this.le) {return this.dataView.getFloat32(e, t)}
        getDouble(e, t=this.le) {return this.dataView.getFloat64(e, t)}
        getUintBytes(e, t, i) {
            switch (t) {
            case 1:
        ...
        toString(e) {return this.dataView.toString(e, this.constructor.name)}
        ensureChunk() {}
    }
    function k(e, t) {
    ...
    class w extends Map {
        ...
        get(e, t) {
            return this.has(e) || k(this.kind, e),
    ...
    class se extends ne {
        ...
        constructor(e, t, i, n) {
            ...
            void 0 !== i)
                if (Array.isArray(i))
                    ...
                    !0 === i || !1 === i ? this.parse = this.enabled = i : m(`Invalid options argument: ${i}`)
        }
        applyInheritables(e) {
            let t, i;
            for (t of te)
        ...
        finalizeFilters() {
            ...
            ue(this.pick, this.deps)) : this.enabled && this.pick.size > 0 && ue(this.pick, this.deps)
        }
    }
    var re = {
        jfif: !1,
    ...
    class oe extends ne {
        ...
        constructor(e) {
            super(),
            !0 === e ? this.setupFromTrue() : void 0 === e ? this.setupFromUndefined() : Array.isArray(e) ? this.setupFromArray(e) : "object" == typeof e ? this.setupFromObject(e) : m(`Invalid options argument ${e}`),
        ...
        setupFromUndefined() {
            ...
            for (e of ee)
                this[e] = re[e];
            for (e of Z)
                this[e] = new se(e,re[e],void 0,this)
        }
        setupFromTrue() {
            let e;
            for (e of $)
        ...
        setupFromObject(e) {
            ...
            for (t of ee)
                this[t] = he(e[t], re[t]);
            for (t of q)
                this[t] = new se(t,re[t],e[t],this);
            for (t of Q)
                this[t] = new se(t,re[t],e[t],this.tiff);
            this.setupGlobalFilters(e.pick, e.skip, Q, Z),
            !0 === e.tiff ? this.batchEnableWithBool(Q, !0) : !1 === e.tiff ? this.batchEnableWithUserValue(Q, e) : Array.isArray(e.tiff) ? this.setupGlobalFilters(e.tiff, void 0, Q) : "object" == typeof e.tiff && this.setupGlobalFilters(e.tiff.pick, e.tiff.skip, Q)
        }
        ...
        checkLoadedPlugins() {
            for (let e of q)
                this[e].enabled && !A.has(e) && k("segment parser", e)
        }
    }
    function le(e, t) {
        let i, n, s, r, a = [];
        ...
        constructor(e, t, i) {
            ...
            f(this, "ensureSegmentChunk", (async e => {
                ...
                if (this.file.chunked)
                    ...
                    this.file.byteLength > t + i ? e.chunk = this.file.subarray(t, i) : void 0 === e.size ? e.chunk = this.file.subarray(t) : m("Segment unreachable: " + JSON.stringify(e));
                return e.chunk
            }
            )),
    ...
    class ye extends pe {
        ...
        setupSegmentFinderArgs(e) {
            !0 === e ? (this.findAll = !0,
            this.wanted = new Set(A.keyList())) : (e = void 0 === e ? A.keyList().filter((e => this.options[e].enabled)) : e.filter((e => this.options[e].enabled && A.has(e))),
            this.findAll = !1,
            ...
            for (; e < t; e++)
                if (255 === l.getUint8(e))
                    ...
                    Se(i)) {
                        ...
                        this.unfinishedMultiSegment || c.delete(s)) : c.delete(s),
                        0 === c.size)))
                            break;
                        f.recordUnknownSegments && (a = ge.findPosition(l, e),
                        a.marker = i,
    ...
    class Pe extends ge {
        ...
        parseTag(e, t, i) {
            ...
            e > n.byteLength && m(`Invalid TIFF value offset. block: ${i.toUpperCase()}, tag: ${t.toString(16)}, type: ${s}, offset ${e} is outside of chunk size ${n.byteLength}`),
            1 === s)
                return n.getUint8Array(e, r);
            if (2 === s)
                return S(n.getString(e, r));
            if (7 === s)
                return n.getUint8Array(e, r);
            if (1 === r)
    ...
    class Ie extends Pe {
        ...
        async parseExifBlock() {
            ...
            return this.interopOffset || (this.interopOffset = e.get(Y)),
            this.makerNote = e.get(z),
            this.userComment = e.get(H),
            this.options.sanitize && (e.delete(Y),
            e.delete(z),
            e.delete(H)),
            this.unpack(e, 41728),
            this.unpack(e, 41729),
        ...
        async parseGpsBlock() {
            ...
            return e && e.has(2) && e.has(4) && (e.set("latitude", ke(...e.get(2), e.get(1))),
            e.set("longitude", ke(...e.get(4), e.get(3)))),
            e
        }
    ...
    "object" == typeof navigator) {
        ...
        if (t.includes("iPad") || t.includes("iPhone")) {
            ...
            if (i) {
                let[,t,n] = i
                  , s = Number(t) + .1 * Number(n);
                e.rotateCanvas = s < 13.4,
                e.rotateCss = !1
            }
    ...
    I.prototype.getUint64 = function(e) {
        ...
        return t < 1048575 ? t << 32 | i : void 0 !== typeof a ? (console.warn("Using BigInt because of type 64uint but JS can only handle 53b numbers."),
        a(t) << a(32) | a(i)) : void m("Trying to read 64b value but JS can only handle 53b numbers.")
    }
    ;
    class Ve extends pe {
        parseBoxes(e=0) {
    ...
    class ze extends Ve {
        ...
        findExtentInIloc(e, t) {
            ...
            for (i += u; c--; ) {
                ...
                if (i += 2,
                e === t)
                    return u > 1 && console.warn("ILOC box has more than one extent but we're only processing one\nPlease create an issue at https://github.com/MikeKovarik/exifr with this file"),
    ...
    B(N, "gps", [[0, "GPSVersionID"], [1, "GPSLatitudeRef"], [2, "GPSLatitude"], [3, "GPSLongitudeRef"], [4, "GPSLongitude"], [5, "GPSAltitudeRef"], [6, "GPSAltitude"], [7, "GPSTimeStamp"], [8, "GPSSatellites"], [9, "GPSStatus"], [10, "GPSMeasureMode"], [11, "GPSDOP"], [12, "GPSSpeedRef"], [13, "GPSSpeed"], [14, "GPSTrackRef"], [15, "GPSTrack"], [16, "GPSImgDirectionRef"], [17, "GPSImgDirection"], [18, "GPSMapDatum"], [19, "GPSDestLatitudeRef"], [20, "GPSDestLatitude"], [21, "GPSDestLongitudeRef"], [22, "GPSDestLongitude"], [23, "GPSDestBearingRef"], [24, "GPSDestBearing"], [25, "GPSDestDistanceRef"], [26, "GPSDestDistance"], [27, "GPSProcessingMethod"], [28, "GPSAreaInformation"], [29, "GPSDateStamp"], [30, "GPSDifferential"], [31, "GPSHPositioningError"]]),
    B(G, ["ifd0", "ifd1"], [[274, {
        1: "Horizontal (normal)",
        2: "Mirror horizontal",
        3: "Rotate 180",
    ...
    We.set(41993, Xe),
    We.set(41994, Xe),
    B(V, ["ifd0", "ifd1"], [[50827, function(e) {
        return "string" != typeof e ? P(e) : e
    }
    ], [306, $e], [40091, Je], [40092, Je], [40093, Je], [40094, Je], [40095, Je]]),
    B(V, "exif", [[40960, Ye], [36864, Ye], [36867, $e], [36868, $e], [40962, _e], [40963, _e]]),
    ...
    class St extends pe {
        ...
        extendOptions(e) {
            ...
            i.enabled && t.deps.add(j),
            n.enabled && t.deps.add(W),
            s.enabled && t.deps.add(K),
            t.finalizeFilters()
        }
        async parse() {
    ...
    class Tt extends pe {
        constructor(...e) {
            super(...e),
            f(this, "catchError", (e => this.errors.push(e))),
            f(this, "metaChunks", []),
            f(this, "unknownChunks", [])
        }
        static canHandle(e, t) {
        ...
        async findPngChunksInRange(e, t) {
            ...
            for (; e < t; ) {
                ...
                wt.includes(s) ? this.metaChunks.push(a) : this.unknownChunks.push(a),
                e += r
            }
        }
        parseTextChunks() {
    ...
    f(Dt, "headerLength", 9),
    A.set("jfif", Dt),
    B(N, "jfif", [[0, "JFIFVersion"], [2, "ResolutionUnit"], [3, "XResolution"], [5, "YResolution"], [7, "ThumbnailWidth"], [8, "ThumbnailHeight"]]);
    class Ot extends ge {
        parse() {
            return this.parseTags(),
            this.translate(),
    ...
    f(Ot, "type", "ihdr"),
    A.set("ihdr", Ot),
    B(N, "ihdr", [[0, "ImageWidth"], [4, "ImageHeight"], [8, "BitDepth"], [9, "ColorType"], [10, "Compression"], [11, "Filter"], [12, "Interlace"]]),
    B(G, "ihdr", [[9, {
        0: "Grayscale",
        2: "RGB",
        3: "Palette",
    ...
    B(G, "icc", [[4, Lt], [12, Ut], [40, Object.assign({}, Lt, Ut)], [48, Lt], [80, Lt], [64, {
        0: "Perceptual",
